...
export declare type WrappedFormUtils = {
    ...
    getFieldsError(name: string): Object[];
    /** 判断一个输入控件是否在校验状态*/
    isFieldValidating(name: string): boolean;
    isFieldTouched(names?: Array<string>): boolean;
...
export interface AkFormComponentProps {
    form?: WrappedFormUtils;
}
export declare class FormComponent extends React.Component<AkFormComponentProps, {}> {
}
...
interface AkFormStates {
}
export class AkForm extends Component < AkFormProps,
    AkFormStates > {

    static Item = Form.Item;
    static create: (options?: AkFormCreateOption | undefined) => ComponentDecorator = Form.create;
