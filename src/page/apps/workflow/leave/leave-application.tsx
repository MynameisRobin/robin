            ...
            <AkForm onSubmit={this.handleSubmit} className="login-form">
                ...
                <AkForm.Item>
                    {getFieldDecorator('userName', {
                        ...
                        <AkInput allowClear={true} addonBefore={<AkIcon type="user" />} placeholder="Username" />
                        )}
                </AkForm.Item>
                <AkForm.Item>
                    {getFieldDecorator('password', {
                        ...
                        <AkInput type="password" allowClear={true} addonBefore={<AkIcon type="lock" />} placeholder="Password" />
                        )}
                </AkForm.Item>
                <AkForm.Item>
                    {getFieldDecorator('textarea', {
                        ...
                        <AkInput type="textarea" allowClear={true} placeholder="Description" />
                        )}
                </AkForm.Item>
                <AkForm.Item>
                    ...
                    <AkButton type="primary" htmlType="submit" className="login-form-button">
                        登录
          </AkButton>
                     或者<a>现在注册吧!</a>
                </AkForm.Item>
