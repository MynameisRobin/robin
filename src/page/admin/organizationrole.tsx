...
import {NavLocale, OrganizationPageLocale} from "../../locales/localeid";
...
class OrganizationRoleTable extends AkTable < JobPositions > {}
interface OrganizationRoleAkColumn extends AkColumnProps < JobPositions > {}
interface TreeData extends UserInfo {
    Children?: TreeData[]
}

/***组织角色 */
interface OrganizationRolePageProps extends IntlProps {}
interface OrganizationRolePageStates {
    // 新建按钮loading
    loading?: boolean;
    // 新建的模态框开关
    visible?: boolean;
    // 修改的模态框开关
    visibleEdit?: boolean;
    OrganizationRoleDataList?: JobPositions[];
    /**获取岗位列表 */
    OrganizationRoleRequest?: GetJobPositionsRequest;
    /**添加 */
    postOrganizationRoleRequest?: PostJobPositionsRequest;
    /**编辑 */
    putOrganizationRoleRequest?: PutJobPositionsRequest;
    /**删除 */
    deleteOrganizationRoleRequest?: DeleteJobPositionsRequest;
    /**  指派人显示隐藏 */
...
/** 岗位管理页面 */
class OrganizationRolePage extends Component < OrganizationRolePageProps,
OrganizationRolePageStates > {
    columns : OrganizationRoleAkColumn[]
    ...
    constructor(props, context) {
        ...
        this.columns = [
            {
                title: format({id: OrganizationPageLocale.ColumnName}),
                key: OrganizationPageLocale.ColumnName,
                dataIndex: "JobPositionName"
            }, {
                title: format({id: OrganizationPageLocale.ColumnAssigner}),
                key: OrganizationPageLocale.ColumnAssigner,
                render: (txt, record) => {
                    let name = "";
                    record
                        .Users
                ...
                key: OrganizationPageLocale.ColumnOperation,
                    ...
                    let menuChild = <AkMenu>
                        <AkMenu.Item>
                            <a
                                ...
                                <FormattedMessage id={OrganizationPageLocale.OperationEdit}></FormattedMessage>
                            </a>
                        </AkMenu.Item>
                        <AkMenu.Item>
                            <a
                                ...
                                .remove
                                .bind(this, record)}>
                                <FormattedMessage id={OrganizationPageLocale.OperationRemove}></FormattedMessage>
                            </a>
                        </AkMenu.Item>
                    </AkMenu>
        ...
        this.state = {
            ...
            postOrganizationRoleRequest: {},
            putOrganizationRoleRequest: {},
    ...
    loadUserRole() {
        ...
        JobPositionsAPI
            ...
            .then(data => {
                ...
                userRoleData.push({
                    JobPositionID: "0",
                    JobPositionName: format({id: OrganizationPageLocale.ModalDefaultChoose})
                });
                if (data.Status != "0") {
    ...
    loadMetaData(record : TreeData) {
        ...
        this.setState({loading: true});
        this.state.OrganizationRoleRequest = {
            bindingType: 2,
            bindingTargetID: record.ID
        }
        JobPositionsAPI
            .getJobPositions(this.state.OrganizationRoleRequest)
            .then(data => {
                console.log(data);
                if (data.Status != "0") {
                    AkNotification.warning({message: '提示', description: data.Message});
                ...
                this.setState({
                    ...
                    OrganizationRoleDataList: data.Data,
    ...
    addJobPosition() {
        ...
        this.state.postOrganizationRoleRequest = {
            ID: "0",
            Name: this.state.postOrganizationRoleRequest.Name,
            Ext1: null,
            Ext2: null,
            Ext3: null,
            UserIDs: ids,
        ...
        JobPositionsAPI
            .postJobPositions(this.state.postOrganizationRoleRequest)
            .then(data => {
                if (data.Status == "0") {
    ...
    editJobPosition() {
        ...
        let name = this.state.putOrganizationRoleRequest.Name;
        name = name
            ? name
        ...
        this.state.putOrganizationRoleRequest = {
        ...
        JobPositionsAPI
            .putJobPositions(this.state.putOrganizationRoleRequest)
            .then(data => {
                if (data.Status == "0") {
                    this.loadMetaData(this.state.currentTreeNode);
                } else {
    ...
    remove(record?: JobPositions) {
        ...
        topThis.state.deleteOrganizationRoleRequest = {
        ...
        AkModal.confirm({
            ...
            onOk() {
                JobPositionsAPI
                    .deleteJobPositions(topThis.state.deleteOrganizationRoleRequest)
                    .then(data => {
                        if (data.Status == "0") {
    ...
    renderAddModal() {
        ...
        return topThis.state.visible
            ? <AkModal
                    maskClosable={false}
                    title={format({id: OrganizationPageLocale.ModalTitleAdd})}
                    ...
                    <AkRow type="flex" align="middle" justify="space-around" className="mb20">
                        <AkCol span={4}>
                            {format({id: OrganizationPageLocale.ModalChooseRole})}
                        </AkCol>
                        <AkCol span={20}>
                            <AkSelect
                                allowClear={true}
                                ...
                                defaultValue={"0"}
                                onChange={(value) => {
                                topThis.state.postOrganizationRoleRequest.Name = value + "";
                            }}>
                                {options}
                            </AkSelect>
                        </AkCol>
                    ...
                    <AkRow type="flex" align="middle" justify="space-around" className="mb20">
                        <AkCol span={4}>
                            {format({id: OrganizationPageLocale.ModalAssigner})}
                        </AkCol>
                        <AkCol span={20}>
                            <AkIdentityPicker
                                multiple
    ...
    renderEditModal() {
        ...
        return topThis.state.visibleEdit
            ? <AkModal
                    maskClosable={false}
                    title={format({id: OrganizationPageLocale.ButtonEdit})}
                    ...
                    <AkRow type="flex" align="middle" justify="space-around" className="mb20">
                        <AkCol span={4}>
                            <label htmlFor="">{format({id: OrganizationPageLocale.ModalTitleEdit})}*</label >
                        </AkCol>
                        < AkCol span={20}>
                            <AkSelect
                                allowClear={true}
                                ...
                                onChange={(value) => {
                                this.state.putOrganizationRoleRequest.Name = value + "";
                            }}>
                                {options}
                            </AkSelect>
                        </AkCol>
                    ...
                    <AkRow type="flex" align="middle" justify="space-around" className="mb20">
                        <AkCol span={4}>
                            <label htmlFor="">{format({id: OrganizationPageLocale.ModalAssigner})}</label>
                        </AkCol>
                        <AkCol span={20}>
                            <AkIdentityPicker
                                multiple
    ...
    render() {
        ...
        let search = <AkRow type="flex" align="middle" justify="space-between">
            <AkCol>
                <a
                    ...
                    {format({id: OrganizationPageLocale.SearchNew})}
                </a>
            </AkCol>
        </AkRow>
        ...
        return <AkRow
            ...
            <AkCol md={6} xs={0} lg={5} className="ak-left-content">
                <MainContent WithBack Header={OrganizationPageLocale.SearchRoleOrg}>
            ...
            <AkCol md={18} xs={24} lg={19}>
                <MainContent Header={rightHeader} Search={search}>
                    ...
                    <OrganizationRoleTable
                        ...
                        pagination={false}
                        dataSource={topThis.state.OrganizationRoleDataList}
                        loading={topThis.state.loading}></OrganizationRoleTable >
                </MainContent>
            </AkCol>
        </AkRow>
    }
...
class OrganizationRolePageStyle {
    static inputStyle : React.CSSProperties = {}
}

export default injectIntl(withRouter(OrganizationRolePage))
